...
from non_abelian_gauge_model import t5  # Ensure this import matches your project's structure
...
class NonAbelianDataset(Dataset):
    def __init__(
            self,
            folder,
            image_size,
...
def get_images_dataloader(
    ...
    ds = NonAbelianDataset(folder, image_size)
